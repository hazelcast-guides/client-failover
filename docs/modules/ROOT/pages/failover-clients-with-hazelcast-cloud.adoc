...
. xref:cloud:ROOT:create-serverless-cluster.adoc[Create the {hazelcast-cloud} Serverless cluster] that you'll use as your primary cluster. When the cluster is ready to use, the *Quick Connection Guide* is displayed.
...
. Again, follow the instructions in the *Quick Connection Guide* to download, extract, and connect the preconfigured Java client to your secondary cluster. 
