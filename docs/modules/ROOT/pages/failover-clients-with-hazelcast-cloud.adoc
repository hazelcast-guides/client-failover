...
:url-code-sample-client-failover: https://github.com/hazelcast-guides/client-failover
...
Create two {hazelcast-cloud} Serverless clusters that you'll use as your primary and secondary clusters and then download and connect sample Java clients to them.

. xref:cloud:ROOT:create-serverless-cluster.adoc[Create the {hazelcast-cloud} Serverless cluster] that you'll use as your primary cluster. When the cluster is ready to use, setup details for the Java client are displayed.
...
. xref:cloud:ROOT:create-serverless-cluster.adoc[Create the {hazelcast-cloud} Serverless cluster] that you'll use as your secondary cluster. 
...
[source,java]
----
include::tutorials:client-failover:example$ClientWithSsl.java[tags=!intro-comments;!catch-exceptions]
----
...
. Make sure that both {hazelcast-cloud} Serverless clusters are running.
...
[source,java]
----
include::tutorials:client-failover:example$ClientWithSsl.java[tag=catch-exceptions,indent=0]
----
